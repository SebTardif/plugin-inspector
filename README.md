...
Compare against a sibling OpenClaw checkout with `--openclaw ../openclaw` or `openclawPath`. Do not put `../openclaw` in plugin `defaultCheckoutPath`; that setting is jailed to the plugin root.
